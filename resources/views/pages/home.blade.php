...
<html lang="id">
    ...
    <head>
        <meta charset="utf-8">
        <title>Lab Riset FK Unizar</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="" name="description">

        <link rel="icon" type="image/png" sizes="16x16" href="/website/img/unizar/logo.png">
    ...
    <body>
        ...
        <div class="container-fluid fixed-top">
                    ...
                    <div class="row gx-0">
                        <div class="col-lg-7 text-start">
                            <div class="h-100 d-inline-flex align-items-center me-4">
                                ...
                                <a href="#" class="text-secondary"><span>0370-6175565</span></a>
                            </div>
                            <div class="h-100 d-inline-flex align-items-center">
                                <span class="far fa-envelope me-2 text-dark"></span>
                                <a href="#" class="text-secondary"><span>https://fkunizar.ac.id/</span></a>
                            </div>
                        </div>
            ...
            <div class="container">
                <nav class="navbar navbar-light navbar-expand-sm nav-tambah" >
                    <a href="index.html" class="navbar-brand d-flex">
                        <img src="website/img/unizar/logo.png" style="width: 10%; height: 100%; margin-right: 10px" class="" />
                        <h1 class="mb-0 mt-1">Laboraturium<span class="text-primary"> Riset</span> </h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav ms-lg-auto mx-xl-auto">
                            ...
                            <a href="activity.html" class="nav-item nav-link">Layanan</a>
                            <a href="event.html" class="nav-item nav-link">Pengumuman</a>
                            <a href="sermon.html" class="nav-item nav-link">Gallery</a>
        ...
        <div class="container-fluid hero-header">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="hero-header-inner animated zoomIn rounded radius20">
                            <p class="fs-4 text-dark">Selamat Datang di :</p>
                            <h3 class="display-4 mb-3 text-dark">Laboraturium Riset FK Unizar</h3>
            ...
            <div class="container">
                <div class="row g-5 mb-5">
                    <div class="col-xl-6">
                        <div class="row g-4">
                            <div class="col-6">
                                <img src="website/img/about-1.jpg" class="img-fluid h-100" data-wow-delay="0s" alt="">
                            </div>
                            <div class="col-6">
                                <img src="website/img/about-2.jpg" class="img-fluid pb-3" data-wow-delay="0s" alt="">
                                <img src="website/img/about-3.jpg" class="img-fluid pt-3" data-wow-delay="0s" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <div class="bg-light p-3 mb-4">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-3">
                                    <img src="website/img/about-child.jpg" class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="col-6">
                ...
                <div class="container text-center bg-primary py-5 radius20" data-wow-delay="0s">
        ...
        <div class="container-fluid activities py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" data-wow-delay="0s" style="max-width: 700px;">
                    <p class="fs-5 text-uppercase text-primary">Activities</p>
                    <h1 class="display-3">Here Are Our Activities</h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-6 col-xl-4">
                        <div class="activities-item p-4" data-wow-delay="0s">
        ...
        <div class="container-fluid event py-5">
            <div class="container py-5">
                <h1 class="display-3 mb-5" data-wow-delay="0s">Upcoming <span class="text-primary">Events</span></h1>
                <div class="row g-4 event-item" data-wow-delay="0s">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overflow-hidden mb-5">
                            <img src="website/img/events-1.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overflow-hidden mb-5">
                            <img src="website/img/events-2.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overflow-hidden mb-5">
                            <img src="website/img/events-3.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid sermon py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5" data-wow-delay="0s" style="max-width: 700px;">
                    <p class="fs-5 text-uppercase text-primary">Sermons</p>
                    <h1 class="display-3">Join The Islamic Community</h1>
                </div>
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-6 col-xl-4">
                        <div class="sermon-item" data-wow-delay="0s">
                            <div class="overflow-hidden p-4 pb-0">
                                <img src="website/img/sermon-1.jpg" class="img-fluid w-100" alt="">
                            </div>
                            <div class="p-4">
                   ...
                   <div class="col-lg-6 col-xl-4">
                        <div class="sermon-item wow fadeIn" data-wow-delay="0.3s">
                            <div class="overflow-hidden p-4 pb-0">
                                <img src="website/img/sermon-2.jpg" class="img-fluid w-100" alt="">
                            </div>
                            <div class="p-4">
                                <div class="sermon-meta d-flex justify-content-between pb-2">
                                    <div class="">
                   ...
                   <div class="col-lg-6 col-xl-4">
                        <div class="sermon-item wow fadeIn" data-wow-delay="0.5s">
                            <div class="overflow-hidden p-4 pb-0">
                                <img src="website/img/sermon-3.jpg" class="img-fluid w-100" alt="">
                            </div>
                            <div class="p-4">
                                <div class="sermon-meta d-flex justify-content-between pb-2">
                                    <div class="">
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <h1 class="display-3 mb-5" data-wow-delay="0s">Latest From <span class="text-primary">Our Blog</span></h1>
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-6 col-xl-4">
                        <div class="blog-item" data-wow-delay="0s">
                            <div class="blog-img position-relative overflow-hidden">
                                <img src="website/img/blog-1.jpg" class="img-fluid w-100" alt="">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="blog-item wow fadeIn" data-wow-delay="0.3s">
                            <div class="blog-img position-relative overflow-hidden">
                                <img src="website/img/blog-2.jpg" class="img-fluid w-100" alt="">
                                <div class="bg-primary d-inline px-3 py-2 text-center text-white position-absolute top-0 end-0">01 Jan 2045</div>
                            </div>
                            <div class="p-4">
                                <div class="blog-meta d-flex justify-content-between pb-2">
                   ...
                   <div class="col-lg-6 col-xl-4">
                        <div class="blog-item wow fadeIn" data-wow-delay="0.5s">
                            <div class="blog-img position-relative overflow-hidden">
                                <img src="website/img/blog-3.jpg" class="img-fluid w-100" alt="">
                                <div class="bg-primary d-inline px-3 py-2 text-center text-white position-absolute top-0 end-0">01 Jan 2045</div>
                            </div>
                            <div class="p-4">
                                <div class="blog-meta d-flex justify-content-between pb-2">
            ...
            <div class="container py-5">
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-xl-5">
                        <div class="team-img" data-wow-delay="0s">
                            <img src="website/img/team-1.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="col-lg-8 col-xl-7">
                        <div class="team-item" data-wow-delay="0s">
                            <h1>Anamul Hasan</h1>
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="team-item wow zoomIn" data-wow-delay="0.2s">
                                    <img src="website/img/team-2.jpg" class="img-fluid w-100" alt="">
                            ...
                            <div class="col-md-4">
                                <div class="team-item wow zoomIn" data-wow-delay="0.4s">
                                    <img src="website/img/team-3.jpg" class="img-fluid w-100" alt="">
                                    <div class="team-content text-dark text-center py-3">
                                        <div class="team-content-inner">
                            ...
                            <div class="col-md-4">
                                <div class="team-item wow zoomIn" data-wow-delay="0.6s">
                                    <img src="website/img/team-4.jpg" class="img-fluid w-100" alt="">
                                    <div class="team-content text-dark text-center py-3">
                                        <div class="team-content-inner">
        ...
        <div class="container-fluid testimonial py-5">
            <div class="container py-5">
                ...
                <div class="owl-carousel testimonial-carousel" data-wow-delay="0s">
                    <div class="testimonial-item">
                        <div class="d-flex mb-3">
                            <div class="position-relative">
                                <img src="website/img/testimonial-1.jpg" class="img-fluid" alt="">
                    ...
                    <div class="testimonial-item">
                        <div class="d-flex mb-3">
                            <div class="position-relative">
                                <img src="website/img/testimonial-2.jpg" class="img-fluid" alt="">
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">
                                    <i class="fa fa-quote-left text-dark"></i>
                                </div>
                            </div>
                    ...
                    <div class="testimonial-item">
                        <div class="d-flex mb-3">
                            <div class="position-relative">
                                <img src="website/img/testimonial-3.jpg" class="img-fluid" alt="">
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">
                                    <i class="fa fa-quote-left text-dark"></i>
                                </div>
                            </div>
                    ...
                    <div class="testimonial-item">
                        <div class="d-flex mb-3">
                            <div class="position-relative">
                                <img src="website/img/testimonial-4.jpg" class="img-fluid" alt="">
                                <div class="btn-md-square bg-primary rounded-circle position-absolute" style="top: 25px; left: -25px;">
                                    <i class="fa fa-quote-left text-dark"></i>
                                </div>
                            </div>
        ...
        <!-- Footer Start -->
        <div class="container-fluid footer pt-5" data-wow-delay="0s">
            <div class="container py-5">
                <div class="row py-5">
                    <div class="col-lg-7">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item mt-5">
                            ...
                            <div class="d-flex border-bottom border-secondary py-4">
                                <img src="website/img/blog-mini-1.jpg" class="img-fluid flex-shrink-0" alt="">
                                <div class="ps-3">
                            ...
                            <div class="d-flex py-4">
                                <img src="website/img/blog-mini-2.jpg" class="img-fluid flex-shrink-0" alt="">
                                <div class="ps-3">
                                    <p class="mb-0 text-muted">01 Jan 2045</p>
                                    <a href="" class="text-body">Lorem ipsum dolor sit amet elit eros vel</a>
                                </div>
